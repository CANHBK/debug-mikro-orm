...
export class DeleteResponse extends IResponse {}
...
export function PaginatedResponse<T>(Data: ClassType<T>) {
  @ObjectType(`${Data.name}PaginatedDataResponse`, {
    isAbstract: true,
  ...
  @ObjectType(`${Data.name}BasePaginatedResponse`, {
    isAbstract: true,
    implements: IResponse,
  })
...
export function Response<T>(Data: ClassType<T>) {
  @ObjectType(`${Data.name}BaseResponse`, {
    isAbstract: true,
    implements: IResponse,
  })
