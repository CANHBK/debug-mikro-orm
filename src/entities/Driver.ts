...
@Entity()
export class Driver extends IEmployee {
  @PrimaryKey()
  employeeId: number;
  ...
  @OneToMany(
    ...
    (projectVehicleAssignment) => projectVehicleAssignment.driver,
    { cascade: [Cascade.ALL] }
  )
  @Field(() => [ProjectVehicleAssignment])
  assignment = new Collection<ProjectVehicleAssignment>(this);
}
